...
- Path: `\MsdOSModules\Tools\multichoice.exe`
...
- Path: `\MsdOSModules\Tools\SetTimerResolution.exe`
    ...
    - Version: v1.0.0
- Path: `\MsdOSDesktop\3. General Configuration\Timer Resolution\! MeasureSleep.exe`
...
> [!NOTE]  
> This is included in the Playbook and isn't in the MsdOSModules.
