...
# Duplicate Ultimate Performance power scheme, customize it and make it the MsdOS power scheme
...
powercfg /changename scheme_current "MsdOS Power Scheme" "Power scheme optimized for optimal latency and performance."
...
& "$windir\MsdOSModules\Scripts\toggleDev.cmd" -Disable '@("ACPI Processor Aggregator", "Microsoft Windows Management Interface for ACPI")' | Out-Null
