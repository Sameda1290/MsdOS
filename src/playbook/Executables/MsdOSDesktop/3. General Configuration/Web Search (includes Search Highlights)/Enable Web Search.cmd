...
:: Main settings
call "%windir%\MsdOSModules\Scripts\settingsPages.cmd" /unhide search-permissions /silent
(
...
if %errorlevel%==1 call "%windir%\MsdOSDesktop\3. General Configuration\Search Indexing\Enable Search Indexing.cmd" /silent & set ____restart=true
exit /b