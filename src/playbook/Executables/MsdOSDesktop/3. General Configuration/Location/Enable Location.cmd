...
call "%windir%\MsdOSModules\Scripts\settingsPages.cmd" /unhide privacy-location
...
if %errorlevel%==1 (
	...
	call "%windir%\MsdOSModules\Scripts\settingsPages.cmd" /unhide findmydevice /silent
)
if %errorlevel%==2 (
