...
if %errorlevel%==1 (
	start "Enabling Hibernation" "%windir%\MsdOSDesktop\3. General Configuration\Hibernation\Enable Hibernation.cmd"
) else (
	start "Disabling Hibernation" "%windir%\MsdOSDesktop\3. General Configuration\Hibernation\Disable Hibernation (default).cmd"
)
