...
call "%windir%\MsdOSModules\Scripts\setSvc.cmd" Spooler 4
call "%windir%\MsdOSModules\Scripts\setSvc.cmd" PrintWorkFlowUserSvc 4

call "%windir%\MsdOSModules\Scripts\settingsPages.cmd" /hide printers
