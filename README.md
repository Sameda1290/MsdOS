<h1 align="center">
  ...
  <p align="center">
    <a href="https://github.com/Sameda1290/MsdOS/blob/main/LICENSE"><img alt="License" src="https://img.shields.io/github/license/atlas-os/atlas?style=for-the-badge&logo=github&color=1A91FF"/></a>
...
- [Contribution Guidelines](https://docs.atlasos.net/contributions/) (AtlasOS)
- [Branding](https://docs.atlasos.net/branding/) (AtlasOS)

## 🤔 What is MsdOS?

MsdOS, is an open-source project that enhances Windows by conveniently applying privacy, usability, and performance optimizations, all while maintaining functionality and [customizability](https://docs.atlasos.net/getting-started/post-installation/atlas-folder/general-configuration/) (AtlasOS).
